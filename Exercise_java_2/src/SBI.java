...
public class SBI implements Serializable, BankSystem{
    ...
    public void getDetails() {
        ...
        System.out.println("Bank Slogan : Pure Banking, Nothing Els");
        System.out.println("Bank rate of interest : 7.5");
    }

    public void writeTranctionsFile(String operation,double amount){
        try(
                FileWriter file = new FileWriter("BankData/SBItransactions.txt",true);
        )
        {
    ...
    public static void readTranctionsFile() {
        try{
            File file = new File("BankData/SBItransactions.txt");
    ...
    private int SerializationObject(){
...
//        }
    ...
    public static SBI DeserializationObject(int accountNo){
        SBI obj = null;
