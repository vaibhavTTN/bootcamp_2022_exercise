...
public class ICICI implements Serializable, BankSystem{
    ...
    public void getDetails() {
        ...
        System.out.println("Bank Slogan : Khayal Apka");
        System.out.println("Bank rate of interest : 7.5");
    }

    public void writeTranctionsFile(String operation,double amount){
        try(
                FileWriter file = new FileWriter("BankData/ICICItransactions.txt",true);
        )
        {
    ...
    public static void readTranctionsFile() {
        try{
            File file = new File("BankData/ICICItransactions.txt");
...
//        }
    ...
    public static ICICI DeserializationObject(int accountNo){
        ICICI obj = null;
